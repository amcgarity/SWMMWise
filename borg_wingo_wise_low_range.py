...
# AEM 2/16/16  Force Borg to explore lower range by reducing upper bounds by a factor of 4
# drive swmm with borg to solve same problem as in 
...
dbCollection = 'y16m02d16_4000_lower_range'
maxEvaluations = 4000
